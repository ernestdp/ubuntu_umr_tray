...
class PreferencesDialog(Gtk.Dialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('PreferencesUmrTrayDialog')
        new_object = builder.get_object("preferences_umr_tray_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        finish initializing the start of the new PerferencesUmrTrayDialog
        instance.
